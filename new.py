...
def main():
    ...
    lesson_dict = {}
    for skill in lesson:
        lesson_dict[skill.getAttribute("id")] = [skill.getAttribute("classids"), skill.getAttribute("subjectid"), skill.getAttribute("teacherids")]
    print(lesson_dict)
    
    card = doc.getElementsByTagName("card")
    card_dict = {}
    for skill in card:
        card_dict[skill.getAttribute("lessonid")] = [skill.getAttribute("period"), skill.getAttribute("weeks")]
    print(card_dict)
